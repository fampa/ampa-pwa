export default {
  ...
  forms: {
    ...
    send: 'Enviar',
    sendMandate: 'Enviame la orden de domiciliación a {email}',
    sendMandateMessage: 'Te hemos enviado la orden de domiciliación al correo {email} con un enlace para firmarlo',

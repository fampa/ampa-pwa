export default {
  ...
  forms: {
    ...
    send: 'Envia',
    sendMandate: 'Envia\'m el manament de domiciliació a {email}',
    sendMandateMessage: 'T\'hem enviat el manament de domiciliació al correu {email} amb un enllaç per signar-lo',
